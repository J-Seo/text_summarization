...
Original file is located at
    https://colab.research.google.com/drive/125d0Wcfghf9wgAUntb9qMYpD1TB-C5tj
"""
...
def load_data():
    ...
    content, title = list(data_df['content']), list(data_df['topic'])
...
def enc_processing(value, dictionary):
    ...
    for sequence in value:
        ...
        sequences_index += (DEFINES.max_sequence_length - len(sequence_index)) * [dictionary[PAD]]
...
def pred2string(value, dictionary):
    ...
    for word in sentence_string:
        if word not in PAD and not in END:
            answer += word
            answer += " " # 어절 단위 분할
